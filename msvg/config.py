	...
	__ZOOM = {
		'14000': {
			'lines': MapRemoveLayer([
					...
					'url(#pattern',
					'stroke-width:2;stroke-linecap:butt;'				# black road labels
					'stroke-linejoin:round;'							# 	^
					'stroke:rgb(100%,100%,100%);',						# 	^
					'stroke-width:2;stroke-linecap:butt;'				# blue road labels
					'stroke-linejoin:round;'							# 	^
					'stroke:rgb(53.72549%,64.313725%,79.607843%);',		# 	^
					'stroke-width:2;stroke-linecap:butt;'				# green road labels
					'stroke-linejoin:round;'							# 	^
					'stroke:rgb(58.039216%,83.137255%,58.039216%);',	# 	^
